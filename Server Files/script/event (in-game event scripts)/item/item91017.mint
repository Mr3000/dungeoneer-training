	...
	int iRandom = Random(3343);	//확률의 총합을 적는다
			...
			while(true)
			{
				...
				//i값을 하나씩 늘려가면서 case로 구현된 리스트의 아이템의 확률과 비교한다
				{
					...
					case(	5	){	color = 	0xC119F8A	; iCumRate += 	80	;} //	2.393060126
					...
					case(	40	){	color = 	0xD41313	; iCumRate += 	20	;} //	0.598265031
					case(	41	){	color = 	0xEB731C	; iCumRate += 	20	;} //	0.598265031
					case(	42	){	color = 	0xFFF3D4	; iCumRate += 	20	;} //	0.598265031
					case(	43	){	color = 	0xFFFFFF	; iCumRate += 	20	;} //	0.598265031
					case(	44	){	color = 	0xFFE062	; iCumRate += 	20	;} //	0.598265031
					case(	45	){	color = 	0x5CE546	; iCumRate += 	20	;} //	0.598265031
					case(	46	){	color = 	0x0DA92B	; iCumRate += 	20	;} //	0.598265031
					case(	47	){	color = 	0x61002c57	; iCumRate += 	1	;} //	0.029913252
					case(	48	){	color = 	0x66109369	; iCumRate += 	1	;} //	0.029913252
					case(	49	){	color = 	0x6410eee9	; iCumRate += 	1	;} //	0.029913252
