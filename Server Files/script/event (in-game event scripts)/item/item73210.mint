...
////////////////////////////////////////////////////////////////////////////////
{
	...
	while(true)
	{
		...
		{
			// 여기다 넣으세요
			case(0){itemString = `id:19074`; iCumRate += 40;} //성별에 맞는 백호 로브
			case(1){itemString = `id:16069` ; iCumRate += 30;} //백호 장갑
			case(2){itemString = `id:17224` ; iCumRate += 30;} //백호 슈즈
			// 여기다 넣으세요의 끝
			default
			{
				bBreak = true;
